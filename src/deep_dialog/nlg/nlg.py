...
class nlg:
    ...
    def translate_diaact(self, dia_act):
        ...
        # pred_ys, pred_words = nlg_model['model'].forward(inverse_word_dict, dia_act_rep, nlg_model['params'],
        #  predict_model=True)
    ...
    def load_nlg_model(self, model_path):
        ...
        if model_params['params']['model'] == 'lstm_tanh':  # lstm_tanh
            ...
            rnnmodel = LSTMDecoderTanh(diaact_input_size, input_size, hidden_size, output_size)
